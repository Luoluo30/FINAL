...
// 時間快進
void fast_forward_timer(Timer *Obj, double seconds) {
    int64_t current_count = al_get_timer_count(Obj->t);
    int64_t ticks_to_add = seconds * 60;
    al_set_timer_count(Obj->t, current_count + ticks_to_add);
}
