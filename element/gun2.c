...
{
    Gun2 *pDerivedObj = (Gun2 *)malloc(sizeof(Gun2));
    ...
    pObj->Update = Gun2_update;
    pObj->Interact = Gun2_interact;
    pObj->Draw = Gun2_draw;
    pObj->Destroy = Gun2_destroy;
...
{
    Gun2 *Obj = ((Gun2 *)(self->pDerivedObj));
    double dt = 0.5;
...
void _Gun2_update_position(Elements *self, int dx, int dy)
{
}
